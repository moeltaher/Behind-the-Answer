export function createFactoryRoutes(ctx) {
  ...
  function hardwareMontage() {
    ...
    $('#toCh3').addEventListener('click', () => go('abstract2'));
  }
  ...
  return { ch2Intro,factoryOrientation,factoryMonitor,factoryIncident,factoryOutcome,hardwareMontage,abstract2 };
}
