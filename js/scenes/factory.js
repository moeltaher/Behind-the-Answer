export function createFactoryRoutes(ctx) {
  ...
  function factoryOutcome() {
    ...
    $('#toFactoryAbstract')?.addEventListener('click', () => {
      if(!stopped&&!maintenanceResolved()) addDecision('factory-debt-carried','نقلت دين الصيانة إلى الوردية التالية','بقي سبب ارتفاع الجسيمات غير مغلق رغم اجتياز المكونات للفحص النهائي.');
