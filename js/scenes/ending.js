...
export function createEndingRoutes(ctx) {
  ...
  function results() {
    ...
    const operationsHighlight=priorityDecision(operations,['monitoring-check-*','deploy-rollback','deploy-restart','deploy-failover-review','deploy-capacity-load','support-*']);
