...
export const SCENE_CHARACTER = {
  intro: 'user', introLoading: 'user', introError: 'user', finalAnswer: 'user',
  mineOrientation: 'moussa', mineTask: 'moussa', mineInspection: 'moussa', mineEnd: 'moussa',
  factoryOrientation: 'layla', factoryMonitor: 'layla', factoryIncident: 'layla', factoryOutcome: 'layla',
  dcInstall: 'carlos', dcCooling: 'carlos', dcWorkers: 'carlos',
  dataClean: 'noor', dataCleanSummary: 'noor',
  annotationIntro: 'amani', annotationTask: 'amani', annotationReview: 'amani', annotationEnd: 'amani',
  trainingSetup: 'david', trainingRun: 'david', trainingEval: 'david',
  evalTask: 'reem', safetyTest: 'reem', launchDecision: 'reem',
  deployLoad: 'hana', deployIncident: 'hana', onCall: 'hana', deployEnd: 'hana',
  supportTask: 'samer'
};

export function characterForScene(sceneId) {
  return CHARACTERS[SCENE_CHARACTER[sceneId]] || null;
}
