...
export const EVAL_TASKS = [
  ...
  },
  {
    ...
    b: 'أعتذر عن التأخر في تسليم العمل. واجهت ظرفًا أدى إلى تأخير الإنجاز، وأعمل حاليًا على استكماله في أقرب وقت. أشكرك على تفهمك.',
    good: 'b',
    explanation: 'الإجابة ب تحقق طلب الرسالة القصيرة بلغة مباشرة وواضحة، بينما الإجابة أ أطول وأكثر رسمية من المطلوب.'
  },
  {
