...
export const FACTORY_PRODUCTION_STAGES = ['idle','awaiting-completion','complete','inspected'];
export const MINING_INSPECTION_MODES = ['routine','forced'];
export const MINING_INSPECTION_STAGES = ['idle','inspect','diagnosed','repaired','verified'];
