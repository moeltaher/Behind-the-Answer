...
function completeState(){
  ...
  s.decisions=[{id:'fixture',label:'fixture',effectText:'fixture'}];
  return s;
}
...
for(const mutate of [
  ...
  s=>{s.flags.miningInspectionCount=2;},
  s=>{s.flags.miningRiskLevel=3;},
